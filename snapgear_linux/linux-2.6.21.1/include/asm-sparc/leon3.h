...
extern void amba_free_apbslv_device(amba_apb_device *dev);
...
extern void amba_free_ahbslv_device(amba_ahb_device *dev);
...
extern amba_apb_device leon_percpu_timer_dev[16];
#endif
