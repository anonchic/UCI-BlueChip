...
#define PRINT_INST 1
#define myprintf(format, ...) do{ if(PRINT_INST) printk(KERN_CRIT format, __VA_ARGS__); } while(0)
...
#define PRINT_INST 0
#define myprintf(format, ...) do{ if(PRINT_INST) printf(format, __VA_ARGS__); } while(0)
